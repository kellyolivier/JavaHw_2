...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            city.addTeacher(Teacher.GradeLevel.MIDDLE, Teacher.TeachingCertification.MASTERS, 101, 40, "Sam Swanson", "7887995999", 20000, "Charter School");
            city.addTeacher(Teacher.GradeLevel.HIGH, Teacher.TeachingCertification.UNDERGRAD, 102, 76, "Linda Bobley", "2393934299", 1000, "Private School");
        }
        catch(Exception e)
        {
